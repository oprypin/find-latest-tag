...
async function run() {
    try {
        ...
        core.setOutput("tag", await getLatestTag(owner, repo, prefix, releasesOnly, sortTags, regex));
    } catch (error) {
...
async function getLatestTag(owner, repo, prefix, releasesOnly, sortTags, regex) {
